...
export const createNotification = async ({
  ...
  try {
    const response = await fetch(
      `${NEXT_PUBLIC_BACKEND_URL}/admin/notification`,
      {
        method: "POST",
        headers: {
...
export const deleteNotification = async ({
  ...
  try {
    ...
    const response = await fetch(
      `${NEXT_PUBLIC_BACKEND_URL}/admin/notification/?${params.toString()}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
...
export const changeRoleUser = async ({
  ...
  try {
    const response = await fetch(
      `${NEXT_PUBLIC_BACKEND_URL}/admin/user/changeRoleUser`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export const changeStatusUser = async ({
  ...
  try {
    const response = await fetch(
      `${NEXT_PUBLIC_BACKEND_URL}/admin/user/changeStatusUser`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export const markFeedbackAsSpam = async ({
  ...
  try {
    const response = await fetch(
      `${NEXT_PUBLIC_BACKEND_URL}/admin/feedback/markFeedbackAsSpam`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export const movieRequestProcess = async ({
  ...
  try {
    const response = await fetch(
      `${NEXT_PUBLIC_BACKEND_URL}/admin/movie-request/process`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
