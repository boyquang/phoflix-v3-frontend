...
export async function generateMetadata() {
  const title = "PHOFLIX-V3 - Không tìm thấy trang";
  const description =
    "Trang bạn đang tìm kiếm không tồn tại hoặc đã bị xóa. Vui lòng kiểm tra lại đường dẫn hoặc quay về trang chủ PHOFLIX-V3.";
