...
export async function generateMetadata() {
  const title = "PHOFLIX-V3 - Trang không còn hoạt động";
  const description =
    "Trang bạn đang truy cập hiện không còn hoạt động hoặc đã bị gỡ bỏ. Cảm ơn bạn đã đồng hành cùng PHOFLIX-V3.";
